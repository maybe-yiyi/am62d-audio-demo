...
static const char * const yamnet_bucket_names[NUM_BUCKETS] = {
	"speech", "alert", "laugh", "crowd",
	"hvac", "noise", "door", "music", "typing", "applause"
};

static inline void yamnet_init_class_buckets(uint8_t cb[AUDIOSET_CLASSES])
{
	memset(cb, 0xFF, AUDIOSET_CLASSES);
